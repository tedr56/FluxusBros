...
(define (bassparticules id cross)
    (letrec
        (
            (translate-c (mn 1 24 10 'ecart))
            (rotation-c (mn 1 25 10 'rotate-g))
            (rotation-c1 (mn 1 26 3 'rotate-1))
            (rotation-c2 (mn 1 27 3 'rotate-2))
            (size-c (+ 0.2 (mn 1 28 10 'size)))
            (opa-c (mn 1 29 2 'blowop))
            (beat-1 (+ 1 (mn 1 30 1 'beat1)))
            (beat-2 (+ 1 (mn 1 31 1 'beat2)))
            (blow-c (mn 1 22 1 'blow))
            (gravity-c (mn 1 23 1 'gravity))
...
(BassParticules-build 1)
;(BassParticules-Blow 1)
(every-frame (BassParticules 1 1))

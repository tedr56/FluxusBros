(define (planets id cross)
    (let*
        (
            ...
            (g (* gain-a gain-b))
            (blur-c (c "blur" id))
            (nb-element (c "nb-element" id #:coeff 3))
            (r-x (c "r-x" id))
            (r-y (c "r-y" id))
            (r-z (c "r-z" id))
            ...
            (nb-cube (c "nb-cube" id))
            (r-e-x (c "r-e-x" id))
            (r-e-y (c "r-e-y" id))
            (r-e-z (c "r-e-z" id))
            (r-e-time (c "r-e-time" id #:coeff 200))
            (nb-element-element (c "nb-element-element" id #:coeff 30))
                ...
                (increment
                    (lambda (n i s form)
                        (with-state
                            ...
                            (cond  ((= form 1)
                                    (rotate (vector
                                        (* (+ (* r-l-kaos-x-coeff (gh2 (+ 1 (* 14 r-l-kaos-x-freq)) g)) r-l-x) (* (/ 360 (* (asin 1) 4)) (* n i)))
                                        (* (+ (* r-l-kaos-y-coeff (gh2 (+ 1 (* 14 r-l-kaos-y-freq)) g)) r-l-y) (* (/ 360 (* (asin 1) 4)) (* n i)))
                                        (* (+ (* r-l-kaos-z-coeff (gh2 (+ 1 (* 14 r-l-kaos-z-freq)) g)) r-l-z) (* (/ 360 (* (asin 1) 4)) (* n i)))))
                                ...
                                (else
                                    (rotate (vector
                                        (* r-l-x (* (/ 360 (* (asin 1) 4)) (* n i)))
                                        (* r-l-y (* (/ 360 (* (asin 1) 4)) (* n i)))
                                        (* r-l-z (* (/ 360 (* (asin 1) 4)) (* n i)))))
                                    (rotate (vector 0 (* -360 r-l-y-joystick) (* -360 r-l-z-joystick)))
                                    (element)))
                        )
                        (cond ((<= n 1) 0)

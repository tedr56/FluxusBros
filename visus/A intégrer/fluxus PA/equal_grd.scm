...
(set-camera-transform (mtranslate (vector 
        (* (- (* 2 (midi-ccn 0 7)) 1) 1000) 
        (* (- (* 2 (midi-ccn 0 0)) 1) 1000)
        (* (midi-ccn 0 15) -5000) ) )) 
...
;couleur faces
(colour (vector 
        (* (* 0.000005 (* (midi-ccn 0 28) (gh 2))) (+ 1 n)) 
        (* (* 0.000005 (* (midi-ccn 0 29) (gh 8))) (+ 1 n)) 
        (* (* 0.000005 (* (midi-ccn 0 30) (gh 15))) (+ 1 n)))) 
...
(define (render2 n)
;(translate (vmul (vector 0 0 n) (* 1.2 (* 10 (midi-ccn 0 27)))))
